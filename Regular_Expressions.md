...
## <span style="color:yellow">1.基本介紹</span>
<table>
  <thead>
    <th>符號</th>
  ...
  <tbody>
    ...
    <tr><td>*</td><td>比對前一個字元<span style="color:Tomato">零</span>次或更多次</td><td>/bo*/可比對Good booook中的booo，亦可比對Good bk中的 b</td></tr>
    <tr><td>+</td><td>比對前一個字元<span style="color:Tomato">一</span>次或更多次</td><td>/a+/可比對candy中的a，和caaandy中的aaa</td></tr>
    <tr><td>?</td><td>比對前一個字元<span style="color:Tomato">零</span>次或<span style="color:Tomato">一</span>次</td><td>/e?le?/可比對angel中的el</td></tr>
    ...
    <tr><td>\S</td><td>比對任一個<span style="color:Tomato">非</span>空白字元</td><td></td></tr>
...
## <span style="color:yellow">2.Flag</span>
* g 全域搜尋
* i 不區分大小寫
* m 多行搜尋
* u 將patten視為unicode
...
## <span style="color:yellow">3.貪婪模式(greddy)&非貪婪模式(un-greddy)</span>
貪婪模式：
```
...
&emsp;
##### <span style="float:right">by國棟 2022/01/25</span>